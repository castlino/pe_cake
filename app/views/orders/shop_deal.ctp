...
<script type="text/javascript">
    ...
    $(document).ready(function(){
        ...
        $('#countdown_dashboard').countDown({targetDate: {'day': <?php echo $cd_day; ?>,'month': <?php echo $cd_month; ?>,'year': <?php echo $cd_year; ?>,'hour': <?php echo $cd_hour; ?>,'min': <?php echo $cd_min; ?>,'sec': <?php echo $cd_sec; ?>}});
